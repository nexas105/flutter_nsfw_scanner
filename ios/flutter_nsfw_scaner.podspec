...
# Run `pod lib lint flutter_nsfw_scaner.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
...
NSFW image scanning with TensorFlow Lite.
  ...
  # s.resource_bundles = {'flutter_nsfw_scaner_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
